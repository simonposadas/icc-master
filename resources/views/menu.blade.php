...
<body class=" tall-header-page wsite-theme-light  wsite-page-gallery"><div id="wrapper">
	<div id="wrap">
		<div id="wrap-in">
	...
	<table class="wsite-multicol-table">
		<tbody class="wsite-multicol-tbody">
			<tr class="wsite-multicol-tr">
				<td class="wsite-multicol-col" style="width:66.777041942605%; padding:0 15px;">
...
<div style="display:block;font-size:90%"></div>
				...
				</td>				<td class="wsite-multicol-col" style="width:33.222958057395%; padding:0 15px;">
					
						

<div style="text-align:center;"><div style="height: 40px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-small wsite-button-highlight" href="/Merienda" >
...
<div><div class="wsite-multicol"><div class="wsite-multicol-table-wrap" style="margin:0 -15px;">
	<table class="wsite-multicol-table">
		<tbody class="wsite-multicol-tbody">
			<tr class="wsite-multicol-tr">
				<td class="wsite-multicol-col" style="width:66.740331491713%; padding:0 15px;">
...
<div style="display:block;font-size:90%"></div>
				...
				</td>				<td class="wsite-multicol-col" style="width:33.259668508287%; padding:0 15px;">
					
						

<div style="text-align:center;"><div style="height: 40px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-small wsite-button-highlight" href="/Lunch&Dinner" >
...
<div><div class="wsite-multicol"><div class="wsite-multicol-table-wrap" style="margin:0 -15px;">
	<table class="wsite-multicol-table">
		<tbody class="wsite-multicol-tbody">
			<tr class="wsite-multicol-tr">
				<td class="wsite-multicol-col" style="width:66.709021601017%; padding:0 15px;">
...
<div style="display:block;font-size:90%"></div>
				...
				</td>				<td class="wsite-multicol-col" style="width:33.290978398983%; padding:0 15px;">
					
						

<div style="text-align:center;"><div style="height: 40px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-small wsite-button-highlight" href="/kiddie.html" >
<span class="wsite-button-inner">Debut</span>
</a>
<div style="height: 10px; overflow: hidden;"></div></div>
...
<div><div class="wsite-multicol"><div class="wsite-multicol-table-wrap" style="margin:0 -15px;">
	<table class="wsite-multicol-table">
		<tbody class="wsite-multicol-tbody">
			<tr class="wsite-multicol-tr">
				<td class="wsite-multicol-col" style="width:66.836086404066%; padding:0 15px;">
...
<div style="display:block;font-size:90%"></div>
				...
				</td>				<td class="wsite-multicol-col" style="width:33.163913595934%; padding:0 15px;">
					
						

<div style="text-align:center;"><div style="height: 40px; overflow: hidden;"></div>
<a class="wsite-button wsite-button-small wsite-button-highlight" href="/regular-event.html" >
<span class="wsite-button-inner">Kiddie</span>
</a>
