...
<div class="navbar-wrapper">
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3">
        <div class="Details">
          ...
          <h3><Strong>Soup :</Strong><small>   Pumpkin Soup / Mushroom Soup / Nido Soup</small></h3>
          <h3><Strong>Salad :</Strong><small>   Salad Bar
          Garden Salad   (Iceberg Lettuce, Cucumber, Tomatoes, White Onions, Carrots, Kernel Corn)
          Dressings: Caesar and Thousand Island</small></h3>
          <h3><Strong>Main Entree :</Strong><small>   (A choice of 1 per dish)
          Fettuccine Alfredo / Carbonarra / Baked Macaroni / 
          Italian Spaghetti / Sotanghon Guisado / Camton Guisado
          
          Roast Beef in Oyster and Creamy Mushrooms Sauce / Beef Caldereta / 
          Beef Salpicao / Beef Alapobre / Beef Mechado / Beef Stroganoff
          
          Pork Hamonado / Barbeque Spareribs / Pork Strips in Spicy Sauce / 
          Pork Korean Sesame / Pork Asado 
          ...
          Mixed Vegetables / Lumpiang Ubod / Corn and Carrot          
          
          Steamed Pandan Rice</small></h3>
          <h3><Strong>Dessert :</Strong><small>   Choose 2 desserts
          Fresh Fruits / White Salad / Buco Pandan / Fruit Salad / Brownies and Blondies</small></h3>
   ...
   <div class="next">
   <p><a href="/Main"><button type="button" class="btn btn-primary btn-lg">Back</button>
      <a href="/Details"><button type="button" class="btn btn-primary btn-lg">Next</button></p>
   </div>
