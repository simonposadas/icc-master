...
<body class=" short-header-page wsite-theme-light  wsite-page-regular-event-packages"><div id="wrapper">
    ...
    <h2 class="wsite-content-title" style="text-align:center;"><font size="7">View Reserved Dates</font></h2>
...
<center><h2><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Calendar </h2></center>
                                    <div id="banner-outer">
                                        <div id="banner-inner">
                                        <div class="calendar"> 
    <div id='calendar'></div>
...
<a class="wsite-button wsite-button-small wsite-button-normal" role='button' class='btn btn-primary btn-lg' href="{{ route('r.details') }}" >
